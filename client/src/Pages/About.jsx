...
const About = () => {
  return (
    <div className='flex flex-col gap-3  mx-auto p-6'> 
        <img src="https://w0.peakpx.com/wallpaper/426/90/HD-wallpaper-yuta-okkotsu-zax-edit-jujutsu-kaisen-manga-anime.jpg" alt="Yuta" className='w-20  h-45 mb-5 object-cover' />
        <p className='text-slate-600 font-semibold p-3'>Yuta is a young man with disheveled black hair and dark blue eyes. As a first-year, Yuta's body language made it obvious that he was under a lot of stress. His posture was very unconfident, and he still has dark circles under his eyelids from a lack of sleep. As a second-year student, Yuta's hair has grown longer and he wears it in a more relaxed style instead of a spiky one.
        </p>
        <p className='text-slate-600 font-semibold p-3' >
